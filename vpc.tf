...
resource "aws_route_table" "RB_Public_RouteTable" {
  ...
  tags = {
    Name = "deham14-public-route-table"
  }
}
...
resource "aws_route_table" "RB_Private_RouteTable" {
  vpc_id = aws_vpc.dev_vpc.id
  tags = {
    Name = "deham14-private-route-table"
  }
}
